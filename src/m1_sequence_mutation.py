...
def run_test_zero_changer():
    ...
    # Test 2
    test2 = ([0, 0, 0], [1, 0, 0, 1, 5, 0], [0, 0, 0], [4, 0, 4], [0])
    expected2 = ([1, 2, 3], [1, 4, 5, 1, 5, 6], [7, 8, 9], [4, 10, 4], [11])
    zero_changer(test2)
    print()
    print('Test 2:')
    ...
    # Test 3
    test3 = ([1, 1, 1], [5, 6, 1, 1, 2], [4, 4, 4], [10, 0, 4])
    expected3 = ([1, 1, 1], [5, 6, 1, 1, 2], [4, 4, 4], [10, 1, 4])
    zero_changer(test3)
    print()
    print('Test 1:')
